...
var _webrtc = __webpack_require__(0);
...
window.RTCMultiConnection = function (roomid, forceOptions) {
    ...
    (function () {
        ...
        var isNodejs = (typeof process === 'undefined' ? 'undefined' : _typeof(process)) === 'object' && _typeof(process.versions) === 'object' && process.versions.node && !process.browser;
        if (isNodejs) {
        ...
        var isNodeWebkit = (typeof process === 'undefined' ? 'undefined' : _typeof(process)) === 'object' && _typeof(process.versions) === 'object' && process.versions['node-webkit'];
    ...
    var IceServersHandler = function () {
        function getIceServers(connection) {
            var iceServers = [{
                ...
                'urls': ['stun:stun.l.google.com:19302', 'stun:stun.l.google.com:19302?transport=udp']
            }];
...
var update = __webpack_require__(10)("62bb3ac2", content, true);
